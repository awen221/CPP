...
//{
//public:
//	enum {KEY_DOWN ,KEY_UP ,KEY_TriggerDown ,KEY_TriggerUP ,KEY_Double ,CursorX_Shift ,CursorY_Shift ,PARAM_COUNT } ;
//	int KeyCode ;
//	int Param ;
//
//	ShareInput key ;
...
//			if(key.IsTriggerDown(KeyCode))
//				return true;
//
//		if(Param == KEY_TriggerUP)
//			if(key.IsTriggerUp(KeyCode))
//				return true;
//
//		if(Param == KEY_Double)
//			if(key.IsDouble(KeyCode))
//				return true;
//
...
//	float Len ;
//
//	bool Work(Point_Dir_f& pnt ,int& curActTime)
//	{
...
//			v_EventDir[i].Init();
//	}
//	bool Work(Point_Dir_f& pnt , int& curActTime , int& nextActID)
//	{
//		for(int i = 0 ; i < v_EventParam.size() ; i++)
...
//		}
//	}
//	void Work(Point_Dir_f& pnt ,int timepass)
//	{
...
//	}
//	void Draw(HDC hdc ,const Point_Dir_f& pnt)
//	{
